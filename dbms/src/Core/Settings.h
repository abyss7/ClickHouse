...
#define LIST_OF_SETTINGS(M) \
    ...
    M(SettingLogsLevel, send_logs_level, Logger::Level::none, "Send server text logs with specified minimum level to client. Valid values: 'trace', 'debug', 'information', 'warning', 'error', 'none'") \
